...
# folder_path = r'C:\Users\sanja\Downloads\text files\test'
...
#             metadata = {"text": text}
#
#             index.upsert(vectors=[(filename, embedding.tolist(), metadata)])
#
#             print(f"File '{filename}' processed and upserted to Pinecone.")
...
try:
    ...
    print("Query Embedding (after normalization):", normalize_embedding(query_embedding))
